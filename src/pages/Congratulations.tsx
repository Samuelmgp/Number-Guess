...
export default function Congratulations({ navigateTo, props }: { navigateTo: (to?: string) => void, props?: GameStats }) {
    console.log("Congratulations Page - GameStats:", props);
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-green-400 to-blue-500">
            ...
            <div className="bg-slate-800 bg-opacity-20 p-4 rounded-lg mb-4">
                ...
                <p className="text-white">Accuracy: {props?.accuracy.toFixed(2)}%</p>
            </div>
            <button 
